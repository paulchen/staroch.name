<div class="language"><a href="<?php echo $language_links['de']; ?>" title="Deutsch"><img alt="Deutsch" src="/images/de.png" /></a></div>
<h1>Paul Staroch</h1>
...
<div class="introduction">
	...
	<p>
	Contact: <a href="mailto:paul@staroch.name">paul@staroch.name</a>, <a href="mailto:paulchen@rueckgr.at">paulchen@rueckgr.at</a>
	</p>
